...
const Skills: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      createScrollAnimation('.frontend-skills', 'slideInFromTop');
      ...
      createScrollAnimation('.accessibility-skills', 'slideInFromBottom');
    ...
    if (techGridRef.current) {
      const techItems = Array.from(techGridRef.current.querySelectorAll('.tech-item'));
      techItems.forEach((item, index) => {
        const animations = ['bounceIn', 'flipIn', 'rotateScaleIn', 'elasticScale'];
  ...
  const skillCategories = [
    {
      ...
      skills: [
        { name: "React.js", level: 95, description: "Advanced component architecture, hooks, context API" },
        { name: "HTML5", level: 98, description: "Semantic markup, accessibility best practices" },
        { name: "CSS3", level: 95, description: "Modern CSS, Flexbox, Grid, animations" },
        { name: "TypeScript", level: 90, description: "Type-safe JavaScript development" },
        { name: "JavaScript", level: 95, description: "ES6+, async/await, modern features" }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: "Bootstrap", level: 90, description: "Responsive grid system and components" },
        { name: "Material UI", level: 87, description: "React component library" }
      ]
    },
    {
      ...
      skills: [
        { name: "WCAG 2.1", level: 95, description: "Web Content Accessibility Guidelines" },
        { name: "WCAG 2.2", level: 93, description: "Latest accessibility standards" },
        { name: "Section 508", level: 94, description: "Federal accessibility compliance" },
        { name: "EN 301 549", level: 90, description: "European accessibility standard" },
        { name: "WAVE", level: 90, description: "Web accessibility evaluation tool" },
        { name: "AXE Dev", level: 92, description: "Accessibility testing toolkit" },
        { name: "Sort Site", level: 85, description: "Accessibility scanning and testing" },
        { name: "NVDA", level: 88, description: "Screen reader testing" },
        { name: "JAWS", level: 85, description: "Screen reader compatibility" },
        { name: "Voiceover", level: 87, description: "macOS accessibility testing" }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: "Figma", level: 85, description: "Design to development workflow" },
        { name: "Webpack", level: 80, description: "Module bundling and optimization" },
        { name: "Vite", level: 82, description: "Fast build tool and dev server" },
        { name: "ESLint", level: 88, description: "Code quality and consistency" }
      ]
    },
    {
      ...
      skills: [
        { name: "Agile", level: 90, description: "Agile development methodology" },
        { name: "Scrum", level: 88, description: "Sprint planning and execution" },
        { name: "Jira", level: 85, description: "Issue tracking and project management" },
        { name: "Wrike", level: 80, description: "Team collaboration platform" },
      ...
      <div id="main-content" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12 sm:mb-16 px-4">
          ...
          <p className="text-base sm:text-lg md:text-xl text-secondary-600 max-w-3xl mx-auto leading-relaxed">
            Comprehensive expertise in modern frontend technologies with a focus on accessibility and user experience
          </p>
        </div>
        ...
        <div className="space-y-8 sm:space-y-12 mb-16 sm:mb-20">
          {skillCategories.map((category, categoryIndex) => (
            <div key={categoryIndex} className="bg-white rounded-lg shadow-lg border border-secondary-200 p-4 sm:p-6 lg:p-8">
        ...
        <div className="bg-secondary-50 rounded-lg p-8 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {certifications.map((cert, certIndex) => (
              <div key={certIndex} className="bg-white rounded-lg p-6 border border-secondary-200 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="bg-primary-50 rounded-lg p-8 mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
            <div>
              ...
              <p className="text-lg text-secondary-700 mb-6">
                Creating inclusive web experiences that work for everyone, regardless 
                of their abilities or the technologies they use to access the web.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-secondary-700">WCAG 2.1 & 2.2 Compliance</span>
                </div>
                <div className="flex items-center">
                  ...
                  <span className="text-secondary-700">Screen Reader Optimization</span>
                </div>
                <div className="flex items-center">
                  ...
                  <span className="text-secondary-700">Keyboard Navigation Support</span>
                </div>
                <div className="flex items-center">
                  <div className="text-purple-600 text-xl mr-3">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-secondary-700">Mobile First Approach</span>
                </div>
                <div className="flex items-center">
                  ...
                  <span className="text-secondary-700">Color Contrast Optimization</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-secondary-600 font-medium">Testing Tools</div>
            </div>
            <div>
